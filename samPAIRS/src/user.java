...
public class user extends javax.swing.JFrame {
    ...
    public user() {
        ...
        setTitle("Version - " + TrendMain.Version);
		...
		try{
				...
				try{
					...
					if (!ClientCode.equals(null)){
						if (DBUpdate == 1){
							...
							String[] LoginDetails = DBObj.LoginDetails(ClientString[0], ClientString[1]);
							if (a.equalsIgnoreCase(LoginDetails[0]) && b.equals(LoginDetails[1])){
								ConnectionCheck = true;
								ErrorMessage = "Authentication Succesful";
							}else{
						    	ErrorMessage = "Invalid Login Password";
							}
							if (LoginDetails[0].equals("Fail")){
								ErrorMessage = "Cannot connect to server...";
							}
						}else{
							UtilObj.WriteLogFile("Connecting to ftp...");
							String s="ftp://samssara:s1a2m3s3$@ftp.samssara.com/samTrend/users.txt";
			...
			if (ConnectionCheck){
				if (CheckForUpdates == 1){
					DBMain DBObj = new DBMain();
					double LatestVersion = DBObj.getLatestVersion();
				    double CurrentVersion = TrendMain.Version;
			    	if (CurrentVersion < LatestVersion){
			    		try{
				    		Process Update = Runtime.getRuntime().exec("UpdatePAIRS.exe");
					    	System.exit(0);
			    		}catch (Exception e){
			    		}
			    	}
